  ...
  if(pomodoro.etat != (EtatPomodoro)etat)
  {
    ...
    case EnCourtePause:
      if(!pomodoro.actif)
      {
        ...
        labelEtatPomodoro = tempsHorloge.getMMSS()  + String(" Pause courte");
        arreterTimerPomodoro();
    ...
    case EnLonguePause:
      if(!pomodoro.actif)
      {
        ...
        labelEtatPomodoro = tempsHorloge.getMMSS()  + String(" Pause longue");
        arreterTimerPomodoro();
...
{
  nettoyerChaines();
  labelUtilisateur = String(prenomUtilisateur.c_str()) + " " + String(nomUtilisateur.c_str());
}
